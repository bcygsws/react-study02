...
export default class List extends React.Component {
	...
	render() {
		...
		// 写法2：
		// a.直接在return语句中使用Array的map方法进行遍历，map意思是进行某个操作，然后返回一个数组，或者一个空数组。重要：
		// 这并不违反【在{}括号内只能使用表达式，其含义可以延展为本身是表达式，或者js代码返回值是表达式】
		// b.数组map，就是数组中的每一项都经过提供的函数（提供的函数可以有返回值return这种形式，也可以没有返回值，提供的函数如：
